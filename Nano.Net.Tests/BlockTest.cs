...
namespace Nano.Net.Tests
{
    public class BlockTest
    {
        ...
        [Fact]
        public void BlockSigningWrongKeyTest()
        {
            Assert.Throws<Exception>(() => _testBlock.Sign(Utils.HexToBytes("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")));
        }
        
        [Fact]
        public void SignatureTest()
        {
            _testBlock.Sign(Utils.HexToBytes("A066701E0641E524662E3B7F67F98A248C300017BAA8AA0D91A95A2BCAF8D4D8"));
            Assert.Equal("C3E9714F3FAAFE66074F40FB10C70A5A489CE0A222DBEFB7F39AB3432BF426D5A82E56BA24EBEC01CE37B1990A73CBC33E760F57856637778854FEF98E13F500", _testBlock.Signature, true);
        }
    }
}
