...
namespace Nano.Net.Numbers
{
    ...
    public struct BigDecimal : IComparable, IComparable<BigDecimal>, ICloneable<BigDecimal>
    {
        ...
        public int SignifigantDigits
        {
            get { return GetSignifigantDigits(Mantissa); }
        }

        public int DecimalPlaces
        {
            get { return (SignifigantDigits + Exponent); }
        }

        public BigInteger WholeValue
        {
            get { return GetWholePart(); }
        }

        public int Length
        {
            get { return BigDecimal.GetSignifigantDigits(this.Mantissa) + this.Exponent; }
        }
        ...
        public BigInteger GetWholePart()
        {
            ...
            string[] valueSplit =
                decimalString.Split(new string[] { BigDecimalNumberFormatInfo.NumberDecimalSeparator }, StringSplitOptions.RemoveEmptyEntries);
